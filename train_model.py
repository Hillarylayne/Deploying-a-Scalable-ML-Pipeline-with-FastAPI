...
# Tip: this points to the repo root automatically.
...
# save the model and the encoder (+ lb for later inference)
...
print("Model saved to model/lb.pkl")
...
for col in cat_features:
    ...
    for slicevalue in sorted(test[col].unique()):
        ...
        with open(slice_output_path, "a", encoding="utf-8") as f:
